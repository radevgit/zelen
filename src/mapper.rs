...
impl<'a> MappingContext<'a> {
    ...
    fn map_constraint(&mut self, constraint: &Constraint) -> FlatZincResult<()> {
        match constraint.predicate.as_str() {
            ...
            "fzn_int_eq_reif" | "int_eq_reif" | "int_eq_imp" => self.map_int_eq_reif(constraint),
            "fzn_int_ne_reif" | "int_ne_reif" | "int_ne_imp" => self.map_int_ne_reif(constraint),
            "fzn_int_lt_reif" | "int_lt_reif" | "int_lt_imp" => self.map_int_lt_reif(constraint),
            "fzn_int_le_reif" | "int_le_reif" | "int_le_imp" => self.map_int_le_reif(constraint),
            "fzn_int_gt_reif" | "int_gt_reif" | "int_gt_imp" => self.map_int_gt_reif(constraint),
            "fzn_int_ge_reif" | "int_ge_reif" | "int_ge_imp" => self.map_int_ge_reif(constraint),
            ...
            "fzn_bool_clause" | "bool_clause" => self.map_bool_clause(constraint),
            ...
            "fzn_array_bool_and" | "array_bool_and" => self.map_array_bool_and(constraint),
            "fzn_array_bool_or" | "array_bool_or" => self.map_array_bool_or(constraint),
            // Bool-int conversion
            ...
            "fzn_at_least_int" | "at_least_int" => self.map_at_least_int(constraint),
            "fzn_at_most_int" | "at_most_int" => self.map_at_most_int(constraint),
            "fzn_exactly_int" | "exactly_int" => self.map_exactly_int(constraint),
            // Global cardinality constraints
            "fzn_global_cardinality" | "global_cardinality" | "gecode_global_cardinality" => self.map_global_cardinality(constraint),
            "fzn_global_cardinality_low_up_closed" | "global_cardinality_low_up_closed" | "gecode_global_cardinality_low_up_closed" => self.map_global_cardinality_low_up_closed(constraint),
            // Element constraints (array indexing)
            "fzn_array_var_int_element" | "array_var_int_element" | "gecode_int_element" => self.map_array_var_int_element(constraint),
            "fzn_array_int_element" | "array_int_element" => self.map_array_int_element(constraint),
            "fzn_array_var_bool_element" | "array_var_bool_element" => self.map_array_var_bool_element(constraint),
            "fzn_array_bool_element" | "array_bool_element" => self.map_array_bool_element(constraint),
            "fzn_array_var_float_element" | "array_var_float_element" => self.map_array_var_float_element(constraint),
            "fzn_array_float_element" | "array_float_element" => self.map_array_float_element(constraint),
